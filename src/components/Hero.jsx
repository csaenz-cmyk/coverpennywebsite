...
export default function Hero() {
  ...
  return (
    <section id="top" className="relative overflow-hidden bg-cream pt-28 pb-20 sm:pt-32 sm:pb-28">
      {/* Decorative pink circle */}
      <div className="pointer-events-none absolute -right-24 -top-10 h-[34rem] w-[34rem] rounded-full bg-penny-100 sm:-right-10" />
      <div className="pointer-events-none absolute right-32 top-24 hidden h-4 w-4 animate-float rounded-full bg-penny-500 sm:block" />
      ...
      <div className="section relative">
        ...
        <motion.h1
          className="display mt-5 max-w-3xl text-5xl text-ink sm:text-7xl"
        ...
        <motion.p
          className="mt-6 max-w-xl text-lg text-ink-soft text-balance"
          initial={{ opacity: 0, y: 18 }}
          animate={{ opacity: 1, y: 0 }}
